...
const controlRecipe = async ()=>{
    ...
    try {
        // loading spinner
        _recipeView.recipeView.renderSpiner();
        //loading recipe
        await _modelJs.loadRecipe(id);
        console.log("model.state.recipe", _modelJs.state.recipe);
        const { recipe  } = _modelJs.state;
        _recipeView.recipeView.render(_modelJs.state.recipe);
    } catch (error) {
        console.log(error);
    }
};
...
},{"./model.js":"6Yfb5","url:../img/icons.svg":"iwCpK","./view/recipeView":"2rXJh","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"6Yfb5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"2rXJh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class RecipeView {
    ...
    _generateMarkup() {
        ...
        }).join("")}\n        </ul>\n      </div>\n    \n      <div class="recipe__directions">\n        <h2 class="heading--2">How to cooking it</h2>\n        <p class="recipe__directions-text">\n          This recipe was carefully designed and tested by\n          <span class="recipe__publisher">${this._data.publisher}</span>. Please\n          check out directions at their website.\n        </p>\n        <a\n          class="btn--small recipe__btn"\n          href="${this._data.sourceUrl}"\n          target="_blank"\n        >\n          <span>Directions</span>\n          <svg class="search__icon">\n            <use href="${_iconsSvgDefault.default}#icon-arrow-right"></use>\n          </svg>\n        </a>\n      </div> `;
    }
}
exports.default = new RecipeView();

},{"url:../../img/icons.svg":"iwCpK","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["drOo7","jKMjS"], "jKMjS", "parcelRequire3a11")
